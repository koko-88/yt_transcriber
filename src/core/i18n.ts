...
export const messages = {
  en: {
    ...
    "transcript.copy.plain": "Plain text",
    "transcript.copy.paragraph": "Paragraph text",
    "transcript.copy.segment": "Segment text",
    "transcript.copy.paragraphTs": "Paragraphs with timestamps",
    "transcript.copy.segmentTs": "Segments with timestamps",
    "transcript.copy.markdown": "Copy Markdown",
    ...
    "transcript.export.csv": "CSV (.csv)",
    "transcript.export.docx": "Word (.docx)",
    "transcript.export.pdf": "PDF (.pdf)",
    "transcript.export.pptx": "PowerPoint (.pptx)",
    "transcript.export.timestamps": "Include timestamps",
    "transcript.export.metadata": "Include video metadata",
    "transcript.export.viewHint": "Body uses current view: {view}",
    "transcript.export.chooseTemplate": "Choose a template",
    "transcript.template.clean": "Clean transcript",
    "transcript.template.clean.hint": "Title and timed paragraphs",
    "transcript.template.study": "Study notes",
    "transcript.template.study.hint": "Lecture-style notes layout",
    "transcript.template.report": "Professional report",
    "transcript.template.report.hint": "Report heading with channel",
    ...
    "availability.not-a-video-page":
      "Navigate to a YouTube video to see its transcript",
    ...
    "availability.player-initializing":
      "Waiting for the main video (ads or player startup)…",
    ...
    "library.empty.hint":
      "Save a transcript from the transcript tab to see it here.",
    ...
    "library.clear.confirm":
      "This will delete all saved transcripts, notes, highlights, and tags. This cannot be undone.",
    ...
    "ai.setup.description":
      "Connect an AI provider to summarize and ask questions about transcripts.",
    "ai.provider": "Provider",
    "ai.model": "Model",
    "ai.apiKey": "API Key",
    "ai.apiKey.hint":
      "Stored unencrypted in the extension's private database. Websites and page scripts cannot read it. Anyone who can read your browser profile or run software as you can.",
    ...
    "ai.consent.firefox":
      "This extension will transmit website content to {provider} for AI processing.",
    "ai.strictMode":
      "Strict Local Mode is enabled. Only local AI providers are allowed.",
    ...
    "settings.strictMode.description":
      "Block all remote AI requests. Only local models (Ollama, LM Studio) and Chrome built-in AI are allowed. This does not affect YouTube page traffic or browser updates.",
    ...
    "settings.inPlayerButton.description":
      "Adds a transcript button to the YouTube player controls. Off by default to reduce detection.",
  ...
  ar: {
    ...
    "transcript.copy.plain": "نص عادي",
    "transcript.copy.paragraph": "نص الفقرات",
    "transcript.copy.segment": "نص المقاطع",
    "transcript.copy.paragraphTs": "فقرات مع الأوقات",
    "transcript.copy.segmentTs": "مقاطع مع الأوقات",
    "transcript.copy.markdown": "نسخ ماركداون",
    ...
    "transcript.export.json": "JSON (.json)",
    "transcript.export.csv": "CSV (.csv)",
    "transcript.export.docx": "وورد (.docx)",
    "transcript.export.pdf": "PDF (.pdf)",
    "transcript.export.pptx": "باوربوينت (.pptx)",
    "transcript.export.timestamps": "تضمين الأوقات",
    "transcript.export.metadata": "تضمين بيانات الفيديو",
    "transcript.export.viewHint": "النص يعتمد على العرض الحالي: {view}",
    "transcript.export.chooseTemplate": "اختر قالبًا",
    "transcript.template.clean": "نسخة نظيفة",
    "transcript.template.clean.hint": "عنوان وفقرات موقوتة",
    "transcript.template.study": "ملاحظات دراسية",
    "transcript.template.study.hint": "تخطيط ملاحظات المحاضرة",
    "transcript.template.report": "تقرير مهني",
    "transcript.template.report.hint": "عنوان تقرير مع القناة",
    ...
    "availability.not-a-video-page":
      "انتقل إلى فيديو YouTube لعرض النسخة النصية",
    "availability.fetch-empty":
    ...
    "availability.player-initializing":
      "بانتظار الفيديو الرئيسي (إعلان أو بدء المشغّل)…",
    ...
    "library.clear.confirm":
      "سيؤدي هذا إلى حذف جميع النسخ النصية والملاحظات والتمييزات والعلامات المحفوظة. لا يمكن التراجع عن هذا.",
    ...
    "ai.setup.description":
      "اربط مزود ذكاء اصطناعي لتلخيص النسخ النصية وطرح أسئلة حولها.",
    "ai.provider": "المزود",
    "ai.model": "النموذج",
    "ai.apiKey": "مفتاح API",
    "ai.apiKey.hint":
      "مخزّن بدون تشفير في قاعدة بيانات الإضافة الخاصة. لا تستطيع المواقع والسكربتات قراءته. يمكن لأي شخص يستطيع قراءة ملف المتصفح أو تشغيل برامج بصلاحياتك الوصول إليه.",
    ...
    "ai.consent":
      "سيتم إرسال نص النسخة النصية إلى {provider}. هل تريد المتابعة؟",
    "ai.consent.firefox":
      "ستنقل هذه الإضافة محتوى الموقع إلى {provider} لمعالجة الذكاء الاصطناعي.",
    "ai.strictMode":
      "وضع التقييد المحلي مفعّل. فقط مزودو الذكاء الاصطناعي المحليون مسموح بهم.",
    ...
    "settings.strictMode.description":
      "حظر جميع طلبات الذكاء الاصطناعي عن بُعد. فقط النماذج المحلية (Ollama، LM Studio) والذكاء الاصطناعي المدمج في Chrome مسموح بها. لا يؤثر هذا على حركة صفحة YouTube أو تحديثات المتصفح.",
    ...
    "settings.inPlayerButton.description":
      "يضيف زر نسخ نصي إلى عناصر التحكم في مشغل YouTube. مغلق افتراضياً لتقليل الكشف.",
